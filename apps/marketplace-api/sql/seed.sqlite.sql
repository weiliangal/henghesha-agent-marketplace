-- 恒河沙智能体交易网 SQLite 示例数据
-- 请先执行 schema.sqlite.sql，再执行本文件。
...
SELECT
  ...
  '["/uploads/seed/admission-cover.svg","/uploads/seed/admission-secondary.svg"]',
  '["/uploads/seed/admission-demo.svg","/uploads/seed/admission-demo-2.svg"]',
  '',
  98000,
  '教育',
  'approved',
...
SELECT
  ...
  '["/uploads/seed/sales-cover.svg","/uploads/seed/sales-secondary.svg"]',
  '["/uploads/seed/sales-demo.svg","/uploads/seed/sales-demo-2.svg"]',
  '',
  168000,
  '企业',
  'approved',
...
SELECT
  ...
  '["/uploads/seed/culture-cover.svg","/uploads/seed/culture-secondary.svg"]',
  '["/uploads/seed/culture-demo.svg","/uploads/seed/culture-demo-2.svg"]',
  '',
  128000,
  '文旅',
  'approved',
