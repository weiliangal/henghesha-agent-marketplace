...
const templateCatalog = [
  {
    ...
    name: "招生咨询模板",
    category: "教育",
    summary: "适合学校官网、招生专题页和企业微信接待场景的标准问答模板。",
    description: "覆盖专业推荐、报考条件说明、预约到访和线索沉淀，适合作为招生数字化服务的第一版上线方案。",
    ...
    capabilities: ["多轮问答", "专业推荐", "预约转化", "家长沟通"],
    recommendedPrice: 98000,
    deliveryDays: 7,
    promptTemplate: "请以清晰、可信、具备招生顾问风格的口吻回答问题，并主动引导用户留下城市、专业方向与咨询意向。",
    conversationTemplate: "1. 识别咨询身份 2. 了解成绩与意向 3. 推荐专业或路径 4. 引导预约咨询",
  },
  {
    ...
    name: "售前线索筛选模板",
    category: "企业",
    summary: "适合官网、展会和公众号接待的线索收集与方案初筛模板。",
    description: "帮助企业快速上线标准售前助手，再逐步增加 CRM 对接、行业知识库和报价流程，适合面向销售转化的首期项目。",
    ...
    deliveryDays: 10,
    promptTemplate: "请以专业、克制、商务顾问式的方式识别客户需求，并使用简洁、结构化的语言给出建议方案。",
  ...
  },
  {
    ...
    name: "文旅讲解模板",
    category: "文旅",
    summary: "适合景区、博物馆和城市文旅入口场景的导览与讲解模板。",
    description: "支持路线推荐、景点讲解、活动说明和游客问答，适合作为内容型智能体的标准化底座。",
    ...
    deliveryDays: 9,
    promptTemplate: "请以亲和、可靠、具备导览感的语气介绍景点或活动，并在必要时补充路线建议和游览提醒。",
  ...
  },
  {
    ...
    description: "先用模板跑通角色设定、语气、交互流程和交付范围，再围绕企业数据做二次开发，适合中大型业务部门试点。",
    ...
    deliveryDays: 14,
    promptTemplate: "请根据企业知识库和业务流程输出结构化回复，在必要时给出下一步动作、所需材料和责任角色。",
